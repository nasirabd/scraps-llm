...
def main(cfg_path="configs/train_small.yaml", ckpt_dir="model/checkpoints", out="export/scraps.onnx"):
    ...
    dummy = torch.randint(0, tok.vocab_size(), (1, 128))  # (B, T)
    torch.onnx.export(
        model, dummy, out,
        input_names=["input_ids"], output_names=["logits"],
        opset_version=17, dynamic_axes={"input_ids": {0: "batch", 1: "seq"}, "logits": {0: "batch", 1: "seq"}}
    )
    print("Saved:", out)
